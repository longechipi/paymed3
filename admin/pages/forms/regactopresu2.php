<?php
	...
	$sqlc = ("SELECT COUNT(idviabordaje) as hay
              ...
              WHERE idpresupuesto='".$idpresu."' AND nro_via='2'");
		...
		if($registrados==3)
			{
					...
					echo '<script language="javascript">
						        ...
						        window.location.href="updpresu_vias_abordaje_2.php?idpac='.$idpaci.'"; 
						  </script>';
			}
		else 
			{
				...
				$sqlc = ("SELECT a.idviabordaje,a.idpresupuesto,a.nro_via,a.idbaremo,b.idbaremo,b.costo
