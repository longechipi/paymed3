...
$idec = $_GET['idec'];
$sql = ("SELECT * FROM estadocivil WHERE idecivil = '" . $idec . "'");
...
if (isset($_POST['submit'])) {
    ...
    $str = "UPDATE estadocivil SET estado='" . ucfirst($estado) . "', idecivil='" . $estatus . "' 
          WHERE idecivil = '" . $idec . "'";
    $conexion = $mysqli->query($str);

    echo '<script language="javascript">alert("Actualizacion Exitosa!!!");
                                        window.location.href="rpt_estadocivil.php"; </script>';
}
?>
<!DOCTYPE html>
<html>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Actualizacion de Estado Civil</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../../index.php?usr=1">Home</a></li>
                                <li class="breadcrumb-item active">Actualizacion de Estado Civil</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12"-->
                <div class="card card-primary">
                    <div style="background: #F89921" class="card-header">
                        <h3 class="card-title">Actualizacion de Estado Civil</h3>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $roww['estado']; ?>" name="estado" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
        ...
        <div class="row">
            <div align="center" class="col-12">
                <a href="rpt_estadocivil.php" class="btn btn-secondary">Atras</a>
            </div>
        </div>
        </section>
        <!-- /.content -->
