...
$sql = ("SELECT * FROM serviciosafiliados WHERE idservaf = '" . $idservi . "'");
...
if (isset($_POST['submit'])) {
   ...
   $str = "UPDATE serviciosafiliados SET servicio='".ucfirst($servicio)."', idestatus='".$estatus."' 
          WHERE idservaf= '".$idservi."'";
   $conexion = $mysqli->query($str);

   echo '<script language="javascript">alert("Actualizacion Exitosa!!!");
                                        window.location.href="rpt_servafafiliados.php"; </script>';
}
?>
<!DOCTYPE html>
<html>
   ...
   <div class="wrapper">
      ...
      <div class="content-wrapper">
         ...
         <section class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                     <h1>Actualizacion de Servicio</h1>
                  </div>
                  <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="../../index.php?usr=1">Home</a></li>
                        <li class="breadcrumb-item active">Actualizacion de Servicio</li>
                     </ol>
                  </div>
               </div>
            </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12"-->
            <div class="card card-primary">
               <div style="background: #F89921" class="card-header">
                  <h3 class="card-title">Actualizacion de Servicio</h3>
      ...
      <div class="row">
         <div align="center" class="col-12">
            <a href="rpt_servafafiliados.php" class="btn btn-secondary">Atras</a>
         </div>
      </div>
      </section>
      <!-- /.content -->
