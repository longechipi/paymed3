...
if (isset($_POST['submit'])) {
   ...
   echo '<script language="javascript">alert(" Registro Exitoso !!!");window.location.href="rpt_espmed.php"; </script>';
}
?>
<!DOCTYPE html>
<html>
      ...
      <div class="content-wrapper">
         ...
         <section class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                     <h1> Registro Especialidades Medicas </h1>
                  </div>
                  <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="../../index.php?usr=1">Home</a></li>
                        <li class="breadcrumb-item active">Registro Especialidades Medicas</li>
                     </ol>
                  </div>
               </div>
            </div><!-- /.container-fluid -->
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              <label for="inputName">Especialidad Medica</label>
                              <input type="text" value="" name="especialidadmed" class="form-control">
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
