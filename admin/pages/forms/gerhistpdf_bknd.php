              ...
              <div class="container-fluid">
                ...
                <table  id="pt12" style="width:100%" >
                      <tbody>
                          <tr> 
                              <td>
                                <span style="font-weight: bold;">Estatura:</span>'.$rowhist["estatura"].'
                                <span style="font-weight: bold;"> Peso:</span>'.$rowhist["peso"].'
                              </td>
                          </tr>
                          <tr> 
                              <td><span style="font-weight: bold;">Presion Arterial:</span>'.$rowhist["presion"].'</td>
                          </tr>
                          <tr> 
                              <td><span style="font-weight: bold;">Fuma:</span>'.$rowhist["fumador"].'</td>
                          </tr>
                      </tbody>
                </table>
                <div>
