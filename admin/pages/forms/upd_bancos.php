...
$idbco = $_GET['idbco'];
$sql = ("SELECT * FROM tipoempresa WHERE idtipoempresa = '" . $idtp . "'");
...
if (isset($_POST['submit'])) {
  ...
  $str = "UPDATE tipoempresa SET tipoempresa='" . ucfirst($tipoempresa) . "', idestatus='" . $estatus . "' 
          WHERE idtipoempresa = '" . $idtp . "'";
  $conexion = $mysqli->query($str);

  echo '<script language="javascript">alert("Actualizacion Exitosa!!!");
                                        window.location.href="rpt_tipoempresa.php"; </script>';
}
?>
<!DOCTYPE html>
<html>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Actualizacion de Empresa</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../../index.php?usr=1">Home</a></li>
                <li class="breadcrumb-item active">Actualizacion de Empresa</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        ...
        <div class="card card-primary">
          <div style="background: #F89921" class="card-header">
            <h3 class="card-title">Actualizacion de Empresa</h3>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="inputName">Tipo de Empresa</label>
                    <input type="hidden" value="<?php echo $idtp; ?>" name="idtp">
                    <input type="text" value="<?php echo $roww['tipoempresa']; ?>" name="tipoempresa" class="form-control">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
    ...
    <div class="row">
      <div align="center" class="col-12">
        <a href="rpt_tipoempresa.php" class="btn btn-secondary">Atras</a>
      </div>
    </div>
    </section>
    <!-- /.content -->
