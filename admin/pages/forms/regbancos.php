...
if (isset($_POST['submit'])) {
   ...
   echo '<script language="javascript">alert(" Registro Exitoso !!!");window.location.href="rpt_bancos.php"; </script>';
}
?>
<!DOCTYPE html>
<html>
               ...
               <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Registros Bancarios</li>
                     </ol>
                  </div>
               </div>
            </div><!-- /.container-fluid -->
