...
if (isset($_POST['submit'])) {
  ...
  echo '<script language="javascript">alert("Registro Exitoso !!!");window.location.href="rpt_tpprov.php"; </script>';
}
?>
<!DOCTYPE html>
<html>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Registro tipo de Proveedor</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="row">
      <div align="center" class="col-12">
        <a href="rpt_tipocuenta.php" class="btn btn-secondary">Atras</a>
      </div>
    </div>
    </section>
    <!-- /.content -->
