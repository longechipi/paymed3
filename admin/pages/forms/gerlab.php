<?php
  ...
  //$idrg = $_GET['idrg'];
    ...
    */
    ...
    // Armo -nombre del PDF
    $nombrelabpdf=$rowhist['nombrepaciente']."-".substr($rowhist['fechaconsulta'],0,2).substr($rowhist['fechaconsulta'],3,2).substr($rowhist['fechaconsulta'],6,4)."-Laboratorio.pdf";
...
tr, th, td {
   padding:2px
        ...
        <div class="wrapper">
          ...
          <section class="content">
              ...
              <div class="container-fluid">
                ...
                <div>
                <div>
                <center><p style="font-family:cursive;font-size:21px;">Solicitud de Laboratorio</p></center>
                <table style="width:100%" cellpadding="0" >
                      <tbody>';
                          $html.='<tr><td style="text-align: left"><span style="font-weight: bold;">Examenes de Laboratorio:</span><br>';
                          //if(!empty($rowhist["laboratorio"] ) ) { //No va, ya se valido en gerinfmed.php
        ...
        $bytes = file_put_contents('descarga/'.$nombrelabpdf, $contenido);
       
        // Forzar descarga del PDF
        //$dompdf->stream($nombrelabpdf, [ "Attachment" => true]);
?>
