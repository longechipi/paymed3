		...
		if($up->processed){
            ...
            for ($row = 2; $row <= $highestRow; $row++){ 
                ...
                if ($cedula!='' && $rif!='' && $apellido1!='' && $nombre1!='' && $correo!='' && $movil!='') {
                    ...
                    if ($esta=='0') { // Existe Correo
                      $reg++;
                      $str="INSERT INTO loginn (idlogin, correo, cargo, cedula, clave, privilegios, estatus) 
                      VALUES (NULL, '".$correo."', 'Medico', '".$rif."','123','2', 'A' );";
                      ...
                      $sql .= " (\"null\",\"$idlogin\",\"$cedula\",\"$rif\",\"$apellido1\",\"$apellido2\",\"$nombre1\",\"$nombre2\",\"$movil\",\"$correo\",\"3\", NOW())";
                      $con->query($sql);
                      //$conexion=$mysqli->query($str);
                    }
                }
