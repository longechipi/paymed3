      ...
      <div class="content-wrapper">
         ...
         <section class="content">
            <div align="center" class="col-md-12">
               ...
               <boton class="buttonr"><a style="color: #FFFFFF;font-family: 'Lato', sans-serif;font-size: 18px;font-weight: bold;" href="regtipocuenta.php">Añadir</a></boton>
               <!--/form-->
            </div><br>
            <!-- Default box -->
            <div class="card">
              ...
              <i class="fas fa-times"></i></button-->
               ...
               <div class="card-body p-0">
                  <table class="table table-striped projects">
                     ...
                     <a class="btn btn-info btn-sm" href="upd_tipocuenta.php?idtc=<?php echo $row['idtipocuenta']; ?>"><i class="fas fa-pencil-alt"></i> Editar</a>
                                 <a class="btn btn-danger btn-sm" href="src_del_tipocuenta.php?idtc=<?php echo $row['idtipocuenta'];?>"><i class="fas fa-trash"></i> Eliminar</a>
                              </td>
