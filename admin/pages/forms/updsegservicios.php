		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Servicios Ofrecidos por la Compañía de Seguros</h1>
						</div>
						<div class="col-sm-6">
        ...
        <div class="col-md-12"-->
				<div class="card card-primary">
					<div style="background: #F89921" class="card-header">
						<h3 class="card-title">Servicios Ofrecidos por la Compañía de Seguros</h3>
					...
					<div class="card-body">
						<form action="regservicioseg.php" method="post">
							<div class="row">
								<div class="col-md-3">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select id="cargo1" class="form-control form-control-sm" name="servi" required>
								...
								<div class="form-group">
									...
									<select class="form-control form-control-sm" name="periodo" required>
								...
								<div class="col-md-1">
						          <div class="form-group">
						            ...
						            <input type="text" name="canti" id="canti" maxlength="2" minlength="1" class="form-control form-control-sm" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" >
						          </div>
						        </div>
						        ...
						        <div class="col-md-2">
						          <div class="form-group">
						            ...
						            <input type="text" name="monto" id="monto" minlength="2" maxlength="6" class="form-control form-control-sm" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;">
						          </div>
						        </div>
							...
							<div class="col-md-12">
								...
								<table class="tftable" border="1">
									...
									<?php while ($rowct = mysqli_fetch_array($resulct)) { ?>
										<tr>
											<td><?php
												$queryti = ("SELECT servicio FROM serviciosafiliados 
							  										  WHERE idservaf ='" . $rowct['idserv'] . "'");
											...
											<td align="center">
												<a class="btn btn-danger btn-sm" href="delservicioseg.php?idseg=<?php echo $rowct['idaseg']; ?>&idlin=<?php echo $rowct['idasegserv']; ?>">
							...
							<div align="right" class="col-md-12" style="padding-top: 20px">
								<a href="updsegcontacto.php?id=<?php echo $idaseg;?>" 
								   class="btn btn-main btn-primary btn-lg uppercase" 
								   style="background: #F89921;border-color: #F89921">Anterior</a>
								<a href="updsegbaremo.php?id=<?php echo $idaseg;?>" 
								   class="btn btn-main btn-primary btn-lg uppercase" 
								   style="background: #F89921;border-color: #F89921">Continuar</a>
							</div>
						</form>
						<!-- /.card-body -->
					</div>
