<?php
  ...
  if (isset($_POST['submit'])) {
          /*Busca por Nro de Cedula */
          $nrocedula=$_POST['nrocedula']; //echo $nrocedula;
    if ($cargo=='Asistente1' || $cargo=='Asistente2') {
          if (isset($_SESSION['idloginmed'])) {$idlogin_session = $_SESSION['idloginmed'];}else{$idlogin_session = $_SESSION['idlogin'];}
          // busco idtrabajacon en loginn para poder vincular con idmed
          $sqlasist = ("SELECT idlogin, idtrabajacon FROM loginn WHERE correo='".$usuario."'");
  ...
  <section class="content">
      ...
      <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
       <span>Cedula : <input type="text" name="nrocedula" id="nrocedula" placeholder="V11123123" >
        <input style="background: #fadb61;border-color: #F89921" type="submit" name="submit" value="Buscar" class="btn btn-main btn-suscess btn-sm uppercase" >
        ...
        <div class="card-body p-0">
          ...
          ?>
              <tr>
                ...
                <td class="project_progress"><?php echo $row['operadora'].$row['movil']; ?></td>
                <td class="project-progress"><?php echo $row['correo']; ?></td>
                <td class="project-actions text-right">
                  <a class="btn btn-warning btn-sm" href="updpac.php?i=<?php echo $row['idpaci'];?>"><i class="fa fa-edit"></i></a>
                  <a class="btn btn-danger btn-sm" href="src_del_user.php?idlogin=<?php echo $row['cedula'];?>"><i class="fa fa-trash"></i></a>
                </td>
              </tr>
				<?php } ?>
              </tbody>
