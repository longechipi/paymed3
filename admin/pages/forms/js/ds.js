...
/* Busco Descripcion y mas de los Examenes para mostrar al cargar pagina (reghist_2.php)*/
function buscadescri(idpac,idcita){
   
   jQuery.ajax({
      type: "POST",  
      url: "busdescri_js.php",
      async: false,
       data: {idpac: idpac, idcita: idcita},
      success:function(data){
       console.log(data);
       var descrip = JSON.parse(data);
       console.log(descrip);
       document.getElementById("laboratorio").innerHTML=descrip[0].laboratorio;
       document.getElementById("imagenologia").innerHTML=descrip[0].imagenologia;
       document.getElementById("anatomia").innerHTML=descrip[0].anatomia;
       document.getElementById("interconsultas").innerHTML=descrip[0].interconsultas;
       document.getElementById("otros").innerHTML=descrip[0].otros;
      },
       error:function (){}
     });// fin ajax
}