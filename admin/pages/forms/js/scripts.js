...
// Ori let monthNames = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September','October', 'November', 'December'];
...
function pacdeldia(idclinica) {
    ...
    jQuery.ajax({
                 ...
                 success:function(data){
                    console.log(data);
                    // Verifico Si el Medico da Consulta ese dia en esa Clinica (0=No Consulta)
                    if (data== '0') {
                        Swal.fire('clínica No Da Consulta ',
                        'para el día seleccionado.',
                        'error'
                        )
                        return false;
