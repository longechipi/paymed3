<?php
	...
	// Actualizo en tbl medicos idestatus
	$idmedico=$_GET['idp'];
    $sql = ("UPDATE  medicos SET idestatus='1' WHERE idmed='".$idmedico."'");
    $conexion=$mysqli->query($sql);

    /* - - - - - - - - - - - - - - - - - - -  */
  	$sql = ("SELECT idlogin, apellido1, nombre1, correo FROM medicos WHERE idmed='".$idmedico."'");
  	$arrcli    =$mysqli->query($sql);
  	$rowcli    = mysqli_fetch_array($arrcli);
  	$idloginmed=$rowcli['idlogin'];
    $nombremedico=$rowcli['apellido1'].' '.$rowcli['nombre1'];
    $correo=$rowcli['correo'];
    /* Actualizo en loginn de I->Inactivo a A->Activo */
    //$sql = ("SELECT b.idlogin FROM loginn a , medicos b WHERE a.idlogin=b.idlogin AND b.idmed='".$idmedico."'");
    $sql = ("UPDATE  loginn SET estatus='A' WHERE idlogin='".$idloginmed."'");
    $conexion=$mysqli->query($sql);
                           ...
                           <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                              <tr>
                                 <td align="center" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                    <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 1px; font-weight: 400; line-height: 0; text-align: center; color: #F2F2F2;">Dr(a): '.$nombremedico.' Ahora es miembro de PayMed!</div>
                                 </td>
                              </tr>
                           </table>
                        </div>
                                       ...
                                       <table border="0" cellpadding="0" cellspacing="0" role="presentation" style width="100%">
                                          <tr>
                                             <td align="left" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 26px; font-weight: bold; line-height: 30px; text-align: left; color: #4F4F4F;">¡Aceptada Su Solicitud!<br> Dr.(a): '.$nombremedico.'</div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align: left; color: #4F4F4F;"><br> Gracias por su afiliacion! <br><br> Ahora es miembro de nuestra red internacional. <br>Ya puede ingresar a nuestra plataforma.</div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
