<?php
  ...
  date_default_timezone_set('America/Caracas');
    ...
    // Armo -nombre del PDF
    $nombrepdf=$rowhist['nombrepaciente']."-".substr($rowhist['fechaconsulta'],0,2).substr($rowhist['fechaconsulta'],3,2).substr($rowhist['fechaconsulta'],6,4)."-Imagen.pdf";
              ...
              <div class="container-fluid">
                ...
                <table style="width:100%" cellpadding="0" >
                      <tbody>';
                          ...
                          //if(!empty($rowhist['imagenologia'])){ Antes Verifica es descri de Examen Img
                          if($rowcount!='0'){ 
