...
//echo $sql;exit();
   $result = $mysqli->query($sql); $roww = mysqli_fetch_array($result);
   ...
   <div class="wrapper">
                   ...
                   onKeypress="if (event.keyCode < 65 || event.keyCode > 90 && event.keyCode < 97 || event.keyCode > 122 && event.keyCode = 32) event.returnValue = false;" required name="nbplan" class="form-control">
                        ...
                        <div class="col-md-2">
                           <div class="form-group">
                              ...
                              <input type="text" value="<?php echo $roww['dias'];?>" name="ddplan" maxlength="3" minlength="1" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" required class="form-control">
                           </div>
                        </div>
                        <div class="col-md-3">
                           <div class="form-group">
      ...
      <div class="row">
         <div align="center" class="col-12">
            <a href="rpt_planes.php" class="btn btn-secondary">Atras</a>
         </div>
      </div>
      </section>
      <!-- /.content -->
