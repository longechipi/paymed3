<?php
	...
	function isEmail($email_booking) {
		...
		/*Asigno variables*/
    $idcita = $_POST['idcita'];
    $sql=("SELECT a.nombre, a.apellido, a.correo, a.fechacita, a.horacita, b.apellido1, b.nombre1
		   FROM citas a, medicos b WHERE a.idmed=b.idmed AND a.idcita='".$idcita."';");

	$obj=$mysqli->query($sql);	$arr=$obj->fetch_array(); 	
	$paciente=$arr[1].' '.$arr[0];
	$correo=$arr[2];
    $fechacita=$arr[3];
    $horacita=$arr[4];
    $medico=$arr[5].' '.$arr[6];

    $sql=("UPDATE citas SET idestatus='6' WHERE idcita='".$idcita."';");
...
try {
    ...
    $mail->Subject = 'Confirmaciòn de Cita.' ;
                                       ...
                                       <table border="0" cellpadding="0" cellspacing="0" role="presentation" style width="100%">
                                          <tr>
                                             <td align="left" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 26px; font-weight: bold; line-height: 30px; text-align: left; color: #4F4F4F;">Confirmaciòn Cita Medica!</div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 20px; font-weight: 400; line-height: 25px; text-align: left; color: #4F4F4F;"><br>Sr.(a):'.$paciente.'<br><br> Su Cita Es El Dia:'.$fechacita.' <br><br>a las '.$horacita.'</div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 22px; font-weight: 300; line-height: 25px; text-align: left; color: #4F4F4F;">Doctor: '.$medico.' <br></div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: 300; line-height: 25px; text-align: left; color: #4F4F4F;"><strong>POR FAVOR NOTIFICAR. GRACIAS</strong> <br><br></div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
