  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Listado del Equipo HI</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../index.php?usr=1">Home</a></li>
              <li class="breadcrumb-item active">Equipo HI</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <section class="content">
      ...
      <div class="card">
        <div style="background: #F89921"  class="card-header">
          <h3 class="card-title">Equipo HI</h3>
          ...
          <table class="table table-striped projects">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td class="project_progress"><?php if($row['privilegios']==1){$cargo='DIRECTOR'; echo $cargo;} 
						  									else if($row['privilegios']==3){$cargo='GERENTE'; echo $cargo;} 
																else if($row['privilegios']==6){$cargo='ASESOR'; echo $cargo;} ?></td>
                      <td class="project-actions text-right">
                        <a class="btn btn-info btn-sm" href="moduser.php?idlogin=<?php echo $row['idlogin'];?>"><i class="fas fa-pencil-alt"></i> Editar</a>
                        <a class="btn btn-danger btn-sm" href="src_del_team.php?idlogin=<?php echo $row['idlogin'];?>"><i class="fas fa-trash"></i></a>
                      </td>
                  </tr>
				<?php } ?>
              </tbody>
