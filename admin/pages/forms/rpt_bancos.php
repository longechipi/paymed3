<?php
	...
	$sql = ("SELECT * FROM bancos ORDER BY idbco, tipo");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Listado Bancarios</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../index.php?usr=1">Home</a></li>
              <li class="breadcrumb-item active">Listado Bancarios</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <section class="content">
			<div align="center" class="col-md-12">
				<!--form action="reguser.php" method="POST"-->
					...
					<boton class="buttonr"><a style="color: #FFFFFF;font-family: 'Lato', sans-serif;font-size: 18px;font-weight: bold;" href="regbancos.php">Añadir</a></boton>
				<!--/form-->
			</div><br>
      <!-- Default box -->
      <div class="card">
        <div style="background: #34358f;color: #fff;font-weight: bold;" class="card-header">
            ...
            ?>
                  <tr>
                      ...
                      <td class="project-actions text-right">
						            <a class="btn btn-info btn-sm" href="upd_banco.php?idbk=<?php echo $row['idbco'];?>"><i class="fas fa-pencil-alt"></i> Editar</a>
                        <a class="btn btn-danger btn-sm" href="src_del_banco.php?idbk=<?php echo $row['idbco'];?>"><i class="fas fa-trash"></i> Eliminar</a>
                      </td>
