      ...
      <div class="content-wrapper">
         ...
         <section class="content">
            ...
            <div   style="display:flex ;">
               <div style="background-color:#F89921;border-radius:2px; padding:10px; margin:4px; width:500px;">
                  <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
                     <div style="display:flex ; margin-top:5px;">
                        
                        <label>Estatus</label>
                        <select name="filter" style="width:150px;" class=" custom-select custom-select-sm mr-4 ml-3">
                        ...
                        <div>
                           ...
                           <input type="text" name="nombre" style="width:200px ;" placeholder="Filtrar por Nombre" class="form-control form-control-sm ">
                        </div>
                     </div>
                  </div>
                  <div>
                     <button class="search" type="submit" name="search">Buscar</button>
                  </div>
               </form>
                  <div align="rigth" style="margin-left:300px;">
                     <button class="buttonr">
                        <a style="color: #FFFFFF;font-family: 'Lato', sans-serif;font-size: 18px;font-weight: bold;" 
                           href="regtipocontacto.php">Añadir</a></button>
                  </div>
            </div>
            <br>
            <!-- Default box -->
                  ...
                  <table class="table table-striped projects">
                     ...
                     <tbody>
                        <?php while ($row = mysqli_fetch_array($result)) { ?>
                           <tr>
                              <td><?php echo $row['idtipocontacto']; ?></td>
