<?php
	...
	if(isset($_POST['submit'])){
		...
		$str="INSERT INTO loginn(fullname, correo, usuario, clave, privilegios, estatus) VALUES ('".$fullname."','".$correo."','".$usuario."','".$clave."','2','A'); ";
		$conexion=$mysqli->query($str);
		//echo $str; exit();
		echo '<script language="javascript">alert("Registro Exitoso !!!");
	    window.location.href="rpt_user.php"; </script>';
	}	
?>
<!DOCTYPE html>
<html>
    ...
    <section class="content">
          ...
          <div class="card card-primary">
			...
			<div class="col-md-3">
              <div class="form-group">
                <label for="inputName">1er Nombre</label>
                <input type="text" value=""  name="nombre1" class="form-control" required>
              </div>
			</div>
			<div class="col-md-3">
              <div class="form-group">
                <label for="inputName">2do Nombre</label>
                <input type="text" value=""  name="nombre2" class="form-control">
              </div>
			</div>
			<div class="col-md-3">
              <div class="form-group">
                <label for="inputName">1er Apellido</label>
                <input type="text" value=""  name="apellido1" class="form-control" required>
              </div>
			</div>
			<div class="col-md-3">
              <div class="form-group">
                <label for="inputName">2do Apellido</label>
			...
			<div class="col-md-4">
			  <div class="form-group">
                ...
                <input type="password" pattern=".{6,}" name="clave" class="form-control" required>
				<small>minino 6 digitos</small>
              </div>
			</div>
      ...
      <div class="row">
        <div align="center" class="col-12">
          <a href="rpt_user.php" class="btn btn-secondary">Atras</a>          
        </div>
      </div>
    </section>
    <!-- /.content -->
