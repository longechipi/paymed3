...
if (isset($_POST['submit'])) {
   ...
   echo '<script language="javascript">alert("Actualizacion Exitosa!!!");
                                        window.location.href="upd_terms.php"; </script>';
}
?>
<!DOCTYPE html>
<html>
      ...
      <div class="content-wrapper">
         ...
         <section class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                     <h1>Actualizacion de Terminos y Condiciones</h1>
                  </div>
                  <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="../../index.php?usr=1">Home</a></li>
                        <li class="breadcrumb-item active">Actualizacion de Terminos y Condiciones</li>
                     </ol>
                  </div>
               </div>
            </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12"-->
            <div class="card card-primary">
               <div style="background: #F89921" class="card-header">
                  <h3 class="card-title">Actualizacion de Terminos y Condiciones</h3>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <textarea name="termn" class="form-control"  rows="20"><?php echo $roww['terminos']; ?></textarea>
                           </div>
                        </div>
