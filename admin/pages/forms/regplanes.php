...
if (isset($_POST['submit'])) {
   ...
   $str = "INSERT INTO planes (plan,costo,dias,transaccion,idestatus) 
           VALUES ('".strtoupper($nbplan)."','".$ctplan."','".$ddplan."','".$pcplan."','".$estatus."')";
   $conexion = $mysqli->query($str);

   echo '<script language="javascript">alert(" Registro Exitoso !!!");
                                       window.location.href="rpt_planes.php"; </script>';
}
?>
<!DOCTYPE html>
<html>
   ...
   <div class="wrapper">
      ...
      <div class="content-wrapper">
         ...
         <section class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                     <h1>Registro de Planes Paymed</h1>
                  </div>
                  <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="../../index.php?usr=1">Home</a></li>
                        <li class="breadcrumb-item active">Registros de Planes Paymed</li>
                     </ol>
                  </div>
               </div>
            </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12"-->
            <div class="card card-primary">
               <div style="background: #F89921" class="card-header">
                  <h3 class="card-title">Planes Paymed</h3>
                   ...
                   onKeypress="if (event.keyCode < 65 || event.keyCode > 90 && event.keyCode < 97 || event.keyCode > 122 && event.keyCode = 32) event.returnValue = false;" required name="nbplan" class="form-control">
                        ...
                        <div class="col-md-2">
                           <div class="form-group">
                              ...
                              <input type="text" name="ddplan" maxlength="3" minlength="1" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" required class="form-control">
                           </div>
                        </div>
                        <div class="col-md-3">
                           <div class="form-group">
      ...
      <div class="row">
         <div align="center" class="col-12">
            <a href="rpt_bancos.php" class="btn btn-secondary">Atras</a>
         </div>
      </div>
      </section>
      <!-- /.content -->
