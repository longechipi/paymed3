<?php
	...
	$sql = ("SELECT * FROM paises ORDER BY idestatus, pais");
  ...
  <section class="content">
      ...
      <div class="card">
        <div style="background: #F89921;color: #fff;font-weight: bold;" class="card-header">
          <h3 class="card-title">Listado países</h3>
        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
            ...
            ?>
                  <tr>
                      <td style="text-align:center"><?php echo $row['idpais']; ?></td>
                      ...
                      <td class="project-actions text-right">
                        <?php if ($row['idestatus']=='2') { ?>
						              <a class="btn btn-success btn-sm" href="onoffpais.php?id=<?php echo $row['idpais'];?>&onoff=x1"><i class="fas fa-pencil-alt"></i> Activa</a>
                        <?php }else if ($row['idestatus']=='1') { ?>
                          <a class="btn btn-danger btn-sm" href="onoffpais.php?id=<?php echo $row['idpais'];?>&onoff=x9"><i class="fas fa-pencil-alt"></i> Desactiva</a>
