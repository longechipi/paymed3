...
try {
    ...
    if ($correo1!='') {$mail->addCC($correo1);}
    if ($correo2!='') {$mail->addCC($correo2);}
    ...
    $ruta_nombrepdf="descarga/".$nombrepdf;
    $ruta="descarga/";

    if ($rowhaylab!='0' && $rowhayimg!='0' && $rowhayrec!='0') {  // Todos
      $ruta_nombrelabpdf="descarga/".$nombrelabpdf; 
      $ruta_nombreimgpdf="descarga/".$nombreimgpdf;
      $ruta_nombrerecpdf="descarga/".$nombrerecpdf;
      $mail->addAttachment($ruta_nombrepdf);
      $mail->addAttachment($ruta_nombrelabpdf);
      $mail->addAttachment($ruta_nombreimgpdf);
      $mail->addAttachment($ruta_nombrerecpdf);

    }elseif ($rowhaylab!='0' && $rowhayrec!='0') {                // Informe, Lab y Rec
      $ruta_nombrelabpdf="descarga/".$nombrelabpdf; 
      $ruta_nombrerecpdf="descarga/".$nombrerecpdf;
      $mail->addAttachment($ruta_nombrepdf);
      $mail->addAttachment($ruta_nombrelabpdf);
    ...
    }elseif ($rowhayimg!='0' && $rowhayrec!='0') {                // Informe, Img y Rec
      $ruta_nombreimgpdf="descarga/".$nombreimgpdf;
      $ruta_nombrerecpdf="descarga/".$nombrerecpdf;
      $mail->addAttachment($ruta_nombrepdf);
      $mail->addAttachment($ruta_nombreimgpdf);
    ...
    //echo 'Pdf:'.$ruta_nombrepdf.'-- Lab'.$ruta_nombrelabpdf;exit();
    //Content
    $mail->isHTML(true);                                  //Set email format to HTML
    $mail->Subject = 'Informe Medico.' ;
...
<div class="header" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; line-height: 22px; padding: 15px 0; margin: 0px auto; max-width: 560px;">
   <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                                       ...
                                       <table border="0" cellpadding="0" cellspacing="0" role="presentation" style width="100%">
                                          <tr>
                                             <td align="left" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: bold; line-height: 30px; text-align: left; color: #4F4F4F;">
                                                  Su informe Medico<br><br>
                                                  Sr(a).'.$nombrepaciente.'<br> 
                                                  C.I.:'.$cedula.'<br><br>
                                                  Fecha Consulta:'.$fechacita.'<br><br>
                                          ...
                                          <tr>
                                             <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 13px; font-weight: 300; line-height: 25px; text-align: left; color: #4F4F4F;"><strong>Gracias por preferirnos, usted es nuestra prioridad</strong> <br><br></div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
    ...
    $mail->send();
    //echo "<script language='javascript'> alert('¡Se ha creado su registro!'); window.location.href='rpt_citas.php'; </script>";
    //echo '1';
  } catch (Exception $e) {
