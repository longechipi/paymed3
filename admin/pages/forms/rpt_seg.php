...
if (isset($_POST['submit'])) {
     ...
     if (!empty($_POST['xrzo'])) {
        $donde="1";
          $where = "WHERE a.razsocial LIKE '".$rzo."%' AND a.idpais= b.idpais AND a.idestado=c.idestado 
                    ORDER BY a.razsocial ASC";
     
     }elseif (!empty($_POST['xrif'])) {
        $donde="2";
          $where = "WHERE a.rif LIKE '".$rif."%' AND a.idpais= b.idpais AND a.idestado=c.idestado
                    ORDER BY a.razsocial ASC";
     
     }elseif((!empty($_POST['xpais']))){
        $donde="3";
          $where = "WHERE a.idpais='".$pais."' AND a.idpais= b.idpais AND a.idestado=c.idestado 
                    ORDER BY a.razsocial ASC"; }                    

     }elseif ((!empty($_POST['xestado']))) {
        $donde="4";
          $where = "WHERE a.idestado='".$estado."' AND a.idpais= b.idpais AND a.idestado=c.idestado 
                    ORDER BY a.razsocial ASC";
      
     }elseif ((!empty($_POST['xestatus']))) {
        $donde="5";
          $where = "WHERE a.idestatus='".$estatus."' AND a.idpais= b.idpais AND a.idestado=c.idestado 
                    ORDER BY a.razsocial ASC";     
     
     }elseif (isset($_POST['cancel'])) {
      $donde="6";
         $where = "WHERE a.idpais= b.idpais AND a.idestado=c.idestado ORDER BY a.razsocial ASC"; 
    ...
    if($where==''){
      $sql = ("SELECT a.idaseg, a.idlogin, a.rif, a.razsocial, a.movil, a.telefono, a.correo, a.idestatus,  
      b.pais, c.estado FROM aseguradores a, paises b, estado c WHERE a.idpais= b.idpais AND a.idestado=c.idestado ORDER BY a.razsocial ASC");
    }else{
      $sql = ("SELECT a.idaseg, a.idlogin, a.rif, a.razsocial, a.movil, a.telefono, a.correo, a.idestatus,  
      b.pais, c.estado FROM aseguradores a, paises b, estado c $where");
    }
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <!-- //*FILTRO -->
          ...
          <div align="center">
               <button class="buttonr"><a style="color: #FFFFFF;font-family: 'Lato', sans-serif;font-size: 18px;font-weight: bold;" href="regseg.php">Añadir</a></button>
          </div>
          <br>
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Listado Seguros</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="card">
        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
              ...
              <tr>
                <td><a><?php echo substr($row['razsocial'], 0,25); ?>...</a></td>                      
                <td class="project_progress"><?php echo $row['rif']; ?></td>
                <td class="project-state"><?php echo $row['pais']; ?></td>
                <td class="project-state"><?php echo $row['estado']; ?></td> 
                <td class="project-actions text-right">
                  <a class="btn btn-primary btn-sm" href="updseg.php?id=<?php echo $row['idaseg'];?>"><i class="fa fa-edit"></i></a>
                  <a class="btn btn-secondary btn-sm" href="updsegcontacto.php?id=<?php echo $row['idaseg'];?>"><i class="fa fa-phone"></i></a>
                  <a class="btn btn-secondary btn-sm" style="background-color: #c9863d;border-color: #c9863d" href="updsegservicios.php?id=<?php echo $row['idaseg'];?>"><i class="fa fa-bars"></i></a>
                  <a class="btn btn-secondary btn-sm" style="background-color: #6ac148;border-color: #6ac148" href="updsegbaremo.php?id=<?php echo $row['idaseg'];?>"><i class="fa fa-handshake"></i></a>
                  <a class="btn btn-danger btn-sm" href="src_del_seg.php?id=<?php echo $row['idaseg'];?>"><i class="fa fa-trash"></i></a>
                </td>
              </tr>
				<?php } ?>
              </tbody>
