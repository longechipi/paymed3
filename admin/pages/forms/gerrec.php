<?php
  ...
  */
    ...
    $sqlhist = ("SELECT a.idpaci, a.idcita, b.idmed, d.nrohistoria, a.observaciones, concat(b.nombre1,' ', b.apellido1) as nombremedico, b.rif, b.codcolemed, b.mpss, b.correo, concat(b.codarea,'-', b.telefono) as telefonolocal, a.*, concat(c.nombre1,' ', c.apellido1) as nombrepaciente, c.cedula, c.edad, a.fechadia as fechaconsulta, a.hora as horaconsulta
    ...
    // Armo -nombre del PDF
    $nombrerecpdf=$rowhist['nombrepaciente']."-".substr($rowhist['fechaconsulta'],0,2).substr($rowhist['fechaconsulta'],3,2).substr($rowhist['fechaconsulta'],6,4)."-Recipe.pdf";
...
tr, th, td {
   padding:2px
        ...
        <div class="wrapper">
          ...
          <section class="content">
              ...
              <div class="container-fluid">
                ...
                <div>
                <div>
                <center><p style="font-family:cursive;font-size:21px;">RECIPE MEDICO</p></center>
                
                <table style="width:100%" cellpadding="0" >
                      <tbody>';
                          $html.='<tr>
                                    <td>
                                      <span style="font-weight: bold;">Medicamentos:</span><br>';
                                        while ($rowhistt = mysqli_fetch_array($arrhistt)) {
                                          ...
                                          $html.='<label> -'.$rowhistt["medicamento"].'</label><br>';
                                        } 
                            $html.='</td>
                                      <td>
                                      <span style="font-weight: bold;">Tratamiento:</span><br>';
                                        while ($rowhistt2 = mysqli_fetch_array($arrhistt2)) {
                                          $html.='<label> - Tomar: '.$rowhistt2["dosis"].' cada: '.$rowhistt2["horas"].' horas por: '.$rowhistt2["dias"].'dias </label><br>';
                                        }
                              $html.='</td> 
                                  </tr>
                                  <tr>
                                    ...
                                    <span style="font-weight: bold;">
                                      Indicaciones:</span><br>'.ucwords(strtolower($rowhist['observaciones']));
        ...
        $bytes = file_put_contents('descarga/'.$nombrerecpdf, $contenido);
       
        // Forzar descarga del PDF
        //$dompdf->stream($nombrerecpdf, [ "Attachment" => true]);
?>
