<?php
	...
	$sql = ("SELECT b.razsocial, CONCAT(c.apellido1,' ', c.nombre1) AS nombremedico, 
          CONCAT(a.apellido1,' ', a.nombre1) AS nombrepaciente, a.cedula, a.correo, a.telefono
          FROM pacientes a, aseguradores b, medicos c WHERE a.idaseg=b.idaseg AND   a.idmed=c.idmed;");
  //echo $sql; exit();
      ...
      <div class="card">
        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
              ...
              <tr>
                <td><a><?php echo $row['razsocial']; ?></a></td>                      
                <td class="project_progress"><?php echo $row['nombremedico']; ?></td>
                <td class="project_progress"><?php echo $row['nombrepaciente']; ?></td>
