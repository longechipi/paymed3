      ...
      if($sisi>0){
       ...
       //echo $str;exit();
         ...
         $str = "INSERT INTO loginn (cedula, correo, cargo, clave, privilegios, estatus) 
                 VALUES ('".$nrodoc."','".strtolower($correo)."', 'Paciente', '123','9','A')";
            $conexion = $mysqli->query($str);
         ...
         $str = "INSERT INTO pacientes (idlogin, idmed, idregistrador, apellido1, apellido2, nombre1, nombre2, cedula, fnacimiento, edad, idsexo, correo, operadora, movil, idpais, idestado, idmunicipio, idparroquia, calleav, casaedif, piso, urbanizacion, codpostal, estatus) 
            ...
            $objidp = $mysqli->query($sqlidp); $arridp = $objidp->fetch_array();
            $idpaci = $arridp['idpaci'];
            /* Inserto en el Pivot de Pacientes X Medicos POR DEFINIR
            $sqlinspivot = ("INSERT INTO pacientesxmed(idpacxmed, idmed, idpaci, idestatus) 
            VALUES (null,'".$idmed."','".$idpaci."','1');");
            $conexion = $mysqli->query($sqlinspivot);    */        
               ...
               <div class="card-body">
                  <form enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" onsubmit="return validacion()">
                     <div class="row">
                        ...
                        <div class="col-md-2">
                           <div class="form-group">
                              ...
                              <input type="text" name="edad" id="edad" class="form-control form-control-sm " 
                                     value="<?php if($paso==1){echo $arrdatos['edad'];}?>" readonly>
                           </div>
                        </div>
                        <!-- 2da  -->
                        <?php if(isset($rif)){ ?>
                        ...
                        <div class="col-md-1">
                           <div class="form-group">
                              <label for="nrodoc">Cédula:</label>
                              <select class="form-control form-control-sm " id="tpdoc" name="tpdoc" readonly >
                        ...
                        <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <input type="text" name="movil" id="movil" maxlength="11" minlength="10" class="form-control form-control-sm" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" required 
                                 value="<?php if($paso==1){echo $arrdatos['movil'];}?>">
                           </div>
                        </div> 
                        <div class="col-md-4">
                           <div class="form-group">
                        ...
                        <div id="div-estado" class="col-md-3">
                           <div class="form-group">
                              ...
                              <select id="id_estado" name="idestado" class="form-control form-control-sm" >
                                 <?php if($paso==1){ ?>
                        ...
                        <div id="div-municipio" class="col-md-3">
                           <div class="form-group">
                              ...
                              <select id="id_municipio" name="idmunicipio" class="form-control form-control-sm" name="idmunicipio" >
                                 <?php if($paso==1){ ?>
                        ...
                        <div  id="div-parroquia" class="col-md-3">
                           <div class="form-group">
                              ...
                              <select id="id_parroquia" name="idparroquia" class="form-control form-control-sm "  >
                                 <?php if($paso==1){ ?>
