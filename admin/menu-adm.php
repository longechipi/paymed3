			...
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			  ...
			  <li class="nav-item has-treeview">
				...
				<ul class="nav nav-treeview">    
				 <li class="nav-item">
					<a href="pages/forms/rpt_uclin.php" class="nav-link">
				 ...
				 <li class="nav-item">
					<a href="pages/forms/rpt_team.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
				 ...
				 <!--li class="nav-item">
					<a href="pages/forms/rpt_upac.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Usr Pacientes</p>
					</a>
				 </li-->
				  <!--li class="nav-item">
					<a href="pages/forms/rpt_user.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Usuarios Web</p>
					</a>
				  </li-->                                   
			  ...
			  <li class="nav-item has-treeview">
				...
				<ul class="nav nav-treeview">              
				  <li class="nav-item">
					<a href="pages/forms/rpt_clin.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Clinicas</p>
					</a>
				  </li>
				  <li class="nav-item">
					<a href="pages/forms/rpt_prov.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Proveedores</p>
					</a>
				  </li>
				  <li class="nav-item">
					<a href="pages/forms/rpt_seg.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Aseguradoras</p>
					</a>
				  </li>
				  ...
				  <li class="nav-item">
					<a href="pages/forms/rpt_med.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Medicos</p>
					</a>
				  </li>
				  ...
				  <li class="nav-item">
					<a href="pages/forms/rpt_presupuestos.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Presupuestos</p>
					</a>
				  </li>
				  ...
				  <!--li class="nav-item">
					<a href="pages/forms/rpt_pac.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Pacientes</p>
					</a>
				  </li-->
			  ...
			  <li class="nav-item has-treeview">
				...
				<ul class="nav nav-treeview">              
				  <li class="nav-item">
					<a href="pages/forms/rpt_citas.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Ver Citas</p>
					</a>
				  </li>			  
			 ...
			 <li class="nav-item has-treeview">
				...
				<ul class="nav nav-treeview">              
				  <li class="nav-item">
					<a href="pages/forms/rpt_pres.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Presupuesto</p>
					</a>
				  </li>
				  ...
				  <li class="nav-item">
					<a href="pages/forms/rpt_regpago.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					 <p>Pagos</p>
					</a>
				  </li>
				  <li class="nav-item">
					<a href="pages/forms/baremo_paymed.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					 <p>Baremo Paymed</p>
					</a>
				  </li>
				  ...
				  <li class="nav-item">
					<a href="pages/forms/rpt_apromed.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					 <p>Junta Medica</p>
					</a>
				  </li>
				  <li class="nav-item">
					<a href="pages/forms/rpt_asixmed.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
				  ...
				  <li class="nav-item">
					<a href="pages/forms/updatmed.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
			  ...
			  <li class="nav-item has-treeview">
                  ...
                  <ul class="nav nav-treeview">
                     <li class="nav-item">
                        <a href="pages/forms/rpt_tipoempresa.php" class="nav-link">
                           <i class="far fa-circle nav-icon"></i>
                           <p>Tipo de Empresa</p>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a href="pages/forms/rpt_tipocuenta.php" class="nav-link">
                           <i class="far fa-circle nav-icon"></i>
                           <p>Tipo de Cuenta</p>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a href="pages/forms/rpt_tipocontacto.php" class="nav-link">
                           <i class="far fa-circle nav-icon"></i>
                           <p>Tipo de Contacto</p>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a href="pages/forms/rpt_tpprov.php" class="nav-link">
                           <i class="far fa-circle nav-icon"></i>
                           <p>Tipo de Proveedor</p>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a href="pages/forms/rpt_sexo.php" class="nav-link">
                           <i class="far fa-circle nav-icon"></i>
                           <p>Sexo</p>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a href="pages/forms/rpt_servafafiliados.php" class="nav-link">
                           <i class="far fa-circle nav-icon"></i>
                     ...
                     <li class="nav-item">
                        <a href="pages/forms/rpt_servimg.php" class="nav-link">
                           <i class="far fa-circle nav-icon"></i>
                           <p>Imagenología</p>
                        </a>
                     </li>
                     ...
                     <li class="nav-item">
                        <a href="pages/forms/rpt_frecuencia.php" class="nav-link">
                           <i class="far fa-circle nav-icon"></i>
                           <p>Frecuencia de Pagos</p>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a href="pages/forms/rpt_estadocivil.php" class="nav-link">
                           <i class="far fa-circle nav-icon"></i>
                           <p>Estado Civil</p>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a href="pages/forms/rpt_espmed.php" class="nav-link">
                           <i class="far fa-circle nav-icon"></i>
                           <p>Especialidades Medicas</p>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a href="pages/forms/rpt_bancos.php" class="nav-link">
                           <i class="far fa-circle nav-icon"></i>
                           <p>Registro de Bancos</p>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a href="pages/forms/rpt_planes.php" class="nav-link">
                           <i class="far fa-circle nav-icon"></i>
                           <p>Registro de Planes</p>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a href="pages/forms/upd_terms.php" class="nav-link">
                           <i class="far fa-circle nav-icon"></i>
                           <p>Terminos y Condiciones</p>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a href="pages/forms/rpt_paises.php" class="nav-link">
                           <i class="far fa-circle nav-icon"></i>
                           <p>países</p>
                        </a>
                     </li>
			  ...
			  <li class="nav-item has-treeview">
				...
				<ul class="nav nav-treeview">              
				  <li class="nav-item">
					<a href="pages/forms/rpt_agenda.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Ver Actividades</p>
					</a>
				  </li>			  
			...
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			  ...
			  <li class="nav-item has-treeview">
				...
				<ul class="nav nav-treeview">    				                 
				  <li class="nav-item">
					...
					<a href="pages/forms/updmed.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Actualizar</p>
					</a>
				  </li>                                   
			  ...
			  <li class="nav-item has-treeview">
				...
				<ul class="nav nav-treeview">              
				  ...
				  <li class="nav-item">
					<a href="pages/forms/rpt_pacxmed.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Pacientes</p>
					</a>
				  </li>
				  <!--li class="nav-item">
					<a href="pages/forms/rpt_logo.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Presupuesto</p>
					</a>
				  </li-->
				  <li class="nav-item">
					<a href="pages/forms/rpt_asist.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Asistente</p>
					</a>
				  </li>
				  <li class="nav-item">
					<a href="pages/forms/rpt_horar.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Horarios</p>
					</a>
				  </li>
			  ...
			  <li class="nav-item has-treeview">
				...
				<ul class="nav nav-treeview">              
				  ...
				  <li class="nav-item">
					<a href="pages/forms/rpt_citpac.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Crear Citas</p>
					</a>
				  </li>
			 ...
			 <li class="nav-item has-treeview">
				...
				<ul class="nav nav-treeview">              
				  <li class="nav-item">
					<a href="pages/forms/prefilterpac.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Historia Medica</p>
					</a>
				  </li>  
		  ...
		  <nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			  ...
			  <li class="nav-item has-treeview">
				...
				<ul class="nav nav-treeview">              
				  <li class="nav-item">
					<a href="pages/forms/xxx" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Medicos</p>
					</a>
				  </li>
			...
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			  ...
			  <li class="nav-item has-treeview">
				...
				<ul class="nav nav-treeview">              
				  <li class="nav-item">
					<!--a href="pages/forms/rpt_agenda.php" class="nav-link"-->
					<a href="pages/forms/regprov.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Actualizar</p>
					</a>
				  </li>			  
			  ...
			  <li class="nav-item has-treeview">
				...
				<ul class="nav nav-treeview">              
				  <li class="nav-item">
					<a href="pages/forms/updespec.php" class="nav-link">
					  <i class="far fa-circle nav-icon"></i>
					  <p>Especialidades</p>
					</a>
				  </li>
