...
<div class="col-lg-12 mb-12 order-0">
    <div class="card">
        <div class="d-flex align-items-end row">
            <div class="col-12">
                <div class="card-body">
                    <h5 class="card-title text-primary">Listado Planes Paymed</h5>
                    <div class="text-center">
                        <a class="btn btn-primary" href="regplanes.php" rel="noopener noreferrer"><i class="fi fi-rr-expense"></i> AÑADIR PLANES</a>
                    </div>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="updplanes.php?id=<?php echo $row['idplan'];?>">
                                                    <i class="fi fi-rr-edit"></i> Editar Plan
                                                </a>
                                            </li>
