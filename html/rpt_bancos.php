...
<div class="col-lg-12 mb-12 order-0">
    <div class="card">
        <div class="d-flex align-items-end row">
            <div class="col-12">
                <div class="card-body">
                    <h5 class="card-title text-primary">Listado Bancarios</h5>
                    <div class="text-center">
                        <a class="btn btn-primary" href="regbancos.php" rel="noopener noreferrer"><i class="fi fi-rr-bank"></i> AÑADIR BANCO</a>
                    </div>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="upd_banco.php?idbk=<?php echo $row['idbco'];?>">
                                                    <i class="fi fi-rr-edit"></i> Editar Banco
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="src_del_banco.php?idbk=<?php echo $row['idbco'];?>">
                                                    <i class="fi fi-rr-trash"></i> Eliminar Banco
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
