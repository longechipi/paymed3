...
<div class="col-lg-12 mb-12 order-0">
    <div class="card">
        <div class="d-flex align-items-end row">
            <div class="col-12">
                <div class="card-body">
                    <h5 class="card-title text-primary">Listado de Generos</h5>
                    <div class="text-center">
                        <a class="btn btn-primary" href="regsexo.php" rel="noopener noreferrer"><i class="fi fi-rr-venus-mars"></i> AÑADIR GENERO</a>
                    </div>
                    ...
                    <tbody>
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                            ...
                            <li><a class="dropdown-item" href="src_del_sexo.php?idsex=<?php echo $row['idsexo'];?>"><i class="fi fi-rr-trash"></i> Eliminar Genero</a></li>
