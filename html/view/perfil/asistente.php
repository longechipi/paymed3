    ...
    <div class="row"> <!--INICIO ROW 1 -->
        ...
        <div class="col-md-3 mb-3">
            <div class="form-group">
                ...
                <input type="text" name="cedula" id="cedula" value="<?php echo $row['nrodoc']; ?>" class="form-control" style="text-transform:uppercase;" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" required />
            </div>
        </div>
        ...
        <div class="col-md-3 mb-2">
            <div class="form-group">
                ...
                <input type="text" name="telf" id="telf" value="<?php echo $row['movil']; ?>" class="form-control" style="text-transform:uppercase;"  onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" required/>
            </div>
        </div>
