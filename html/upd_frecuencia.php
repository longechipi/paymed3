    ...
    <div class="layout-container">
        <?php include("../layouts/menu.php"); ?>
            <div class="layout-page">
                ...
                $sql = ("SELECT * FROM frecuenciapago WHERE idfq = '".$idfrecuencia."'");
...
<div class="col-lg-12 mb-12 order-0">
    <div class="card">
        <div class="d-flex align-items-end row">
            <div class="col-12">
                <div class="card-body">
                    <h5 class="card-title text-primary">Editando Frecuencia de Pagos: <?php echo $roww['frecuencia']; ?></h5>
                    <form id="updfrecuencia">
                        <div class="row">
                            <div class="col-md-6">
...
$(document).ready(function(){
    $('#updfrecuencia').submit(function(e){
    e.preventDefault();
    $.ajax({
        type: "POST",
        url: "../model/reg_fre_pagos/updfrecuencia.php",
        data: $("#updfrecuencia").serialize(),
        success: function(data){
            if(data == 1){
                Swal.fire({
                    title: 'Actualización Exitosa!',
                    text: 'Se Actualizo correctamente la Frecuencia',
                    icon: 'success',
                ...
                Swal.fire({
                    title: 'Error!',
                    text: 'Ocurrio un Error al Actualizar la Frecuencia ',
                    icon: 'error',
                    confirmButtonText: 'Aceptar'
                });
            }
