...
<div class="col-lg-12 mb-12 order-0">
    <div class="card">
        <div class="d-flex align-items-end row">
            <div class="col-12">
                <div class="card-body">
                    <h5 class="card-title text-primary">Registro tipo de Proveedor</h5>
                    <form id="regproveedor">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="inputName">Proveedor</label>
                                    <input type="text" value="" name="tipoprov" class="form-control">
                                </div>
                            </div>
...
$(document).ready(function(){
    $('#regproveedor').submit(function(e){
    e.preventDefault();
    $.ajax({
        type: "POST",
        url: "../model/reg_proveedor/regproveedor.php",
        data: $("#regproveedor").serialize(),
        success: function(data){
            console.log(data)
            if(data == 1){
                Swal.fire({
                    title: 'Registro Exitoso!',
                    text: 'Se ha registrado correctamente el Proveedor',
                    icon: 'success',
                    confirmButtonColor: "#007ebc",
                    confirmButtonText: 'Aceptar'
                }).then((result) => {
                    if (result.isConfirmed) {
                        window.location.href = "rpt_tpprov.php";
                    }
                });
            }else{
                Swal.fire({
