...
<div class="col-lg-12 mb-12 order-0">
    <div class="card">
        <div class="d-flex align-items-end row">
            <div class="col-12">
                <div class="card-body">
                    <h5 class="card-title text-primary">Registro tipo de Contacto </h5>
                    <form id="regcontacto">
                        <div class="row">
                            <div class="col-md-6">
...
$(document).ready(function(){
    $('#regcontacto').submit(function(e){
    e.preventDefault();
    $.ajax({
        type: "POST",
        url: "../model/reg_contacto/regcontacto.php",
        data: $("#regcontacto").serialize(),
        success: function(data){
            console.log(data)
            if(data == 1){
                Swal.fire({
                    title: 'Registro Exitoso!',
                    text: 'Se ha registrado correctamente el Contacto',
                    icon: 'success',
                ...
                Swal.fire({
                    title: 'Error!',
                    text: 'Ocurrio un Error al Registrar el Contacto',
                    icon: 'error',
                    confirmButtonText: 'Aceptar'
                });
            }
